...
const verifyOTP = [
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.log("OTP in DB:", debugUser?.resetPasswordToken, typeof debugUser?.resetPasswordToken);
      console.log("Expires in:", debugUser?.resetPasswordExpires - Date.now(), "ms");

      const user = await User.findOne({
        email,
        resetPasswordToken: otpString,
